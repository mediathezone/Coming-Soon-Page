...
$(window).on("load", function() {
    function countDown(){
        var today = new Date();
        //var eventDate = new Date("November 30,2020 00:00:00");
        var eventDate = new Date(today.getFullYear(), today.getMonth(), today.getDate()+39);
        var currentTime = today.getTime();
        var eventTime = eventDate.getTime();
        
        eventDate.setDate(currentTime + 60);
